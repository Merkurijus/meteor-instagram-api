InstagramApiHandler = function () {
	...
	const callEndpoint = function(url, passedOptions, callback) {
		var options = {
			params: {
	...
	self.tags.info = function (options, callback) {
		...
		return callEndpoint( url, options, callback);
	};
	...
	self.users.self = function(options, callback) {
		...
		return callEndpoint(url, null, callback);
	};
